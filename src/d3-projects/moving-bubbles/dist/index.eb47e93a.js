...
!function(t, n) {
    ...
    function Y(t, n) {
        ...
        function l(l) {
            ...
            })(n.copy()), b = l.selection ? l.selection() : l, m = b.selectAll(".domain").data([
                null
            ]), x = b.selectAll(".tick").data(h, n).order(), w = x.exit(), M = x.enter().append("g").attr("class", "tick"), N = x.select("line"), A = x.select("text");
    ...
    j.prototype = I.prototype = {
        ...
        on: function(t, n) {
            ...
            if (!(arguments.length < 2)) {
                ...
                for(; ++a < u;)if (e = (t = o[a]).type) i[e] = X(i[e], t.name, n);
    ...
    function Tt(t, n, e) {
        ...
        return function(i, o, a) {
            ...
            if (c) {
                for(var s = 0, l = c.length; s < l; ++s)if ((u = c[s]).type === t.type && u.name === t.name) return this.removeEventListener(u.type, u.listener, u.capture), this.addEventListener(u.type, u.listener = f, u.capture = e), void (u.value = n);
            }
    ...
    Ct.prototype = Pt.prototype = {
        ...
        on: function(t, n, e) {
            ...
            if (u) {
                for(var c, f = 0, s = u.length; f < s; ++f)for(r = 0, c = u[f]; r < a; ++r)if ((i = o[r]).type === c.type && i.name === c.name) return c.value;
            }
        },
    ...
    function Ut(t, n) {
        ...
        if (e.createSVGPoint) {
            ...
            return r.x = n.clientX, r.y = n.clientY, [
                (r = r.matrixTransform(t.getScreenCTM().inverse())).x,
                r.y
            ];
        }
    ...
    var Kt = "\\s*([+-]?\\d+)\\s*", tn = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*", nn = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", en = /^#([0-9a-f]{3})$/, rn = /^#([0-9a-f]{6})$/, on = new RegExp("^rgb\\(" + [
        Kt,
        Kt,
        Kt
    ] + "\\)$"), an = new RegExp("^rgb\\(" + [
    ...
    Zt(Dn, Rn, Qt(Jt, {
        ...
        rgb: function() {
            ...
            return new yn(Un(3.1338561 * (n = An * Ln(n)) - 1.6168667 * (t = Tn * Ln(t)) - .4906146 * (e = Sn * Ln(e))), Un(-0.9787684 * n + 1.9161415 * t + .033454 * e), Un(.0719453 * n - .2289914 * t + 1.4052427 * e), this.opacity);
        }
    })), Zt(Fn, Yn, Qt(Jt, {
        brighter: function(t) {
    ...
    function Zn(t, n, e, r) {
        return 1 === arguments.length ? function(t) {
            ...
            t instanceof yn || (t = vn(t));
            var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Wn * r + Vn * n - $n * e) / (Wn + Vn - $n), o = r - i, a = (Gn * (e - i) - Hn * o) / Xn, u = Math.sqrt(a * a + o * o) / (Gn * i * (1 - i)), c = u ? Math.atan2(a, o) * Nn - 120 : NaN;
    ...
    function De(t, n) {
        ...
        if (h < ze) r = Math.log(f / a) / Ee, e = function(t) {
            ...
            var d = Math.sqrt(h), p = (f * f - a * a + Pe * h) / (2 * a * Ce * d), v = (f * f - a * a - Pe * h) / (2 * f * Ce * d), g = Math.log(Math.sqrt(p * p + 1) - p), y = Math.log(Math.sqrt(v * v + 1) - v);
    ...
    var He, Xe, Ge = 0, Ve = 0, $e = 0, We = 1e3, Ze = 0, Qe = 0, Je = 0, Ke = "object" == typeof performance && performance.now ? performance : Date, tr = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17);
    };
    function nr() {
        ...
        tween: function(t, n) {
            ...
            return this.each((null == n ? function(t, n) {
                ...
                return function() {
                    ...
                    if (o !== e) {
                        for(var a = 0, u = (r = e = o).length; a < u; ++a)if (r[a].name === n) {
    ...
    function Pi(n) {
        ...
        function u(t) {
            var e = t.property("__brush", h).selectAll(".overlay").data([
                Ti("overlay")
            ]);
            e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", xi.overlay).merge(e).each(function() {
                ...
                Ti("selection")
            ]).enter().append("rect").attr("class", "selection").attr("cursor", xi.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
        ...
        function l() {
            ...
            if (i.apply(this, arguments)) {
                var r, o, a, u, s, l, h, d, p, v, g, y, _, b = this, m = t.event.target.__data__.type, x = "selection" === (t.event.metaKey ? m = "overlay" : m) ? pi : t.event.altKey ? yi : gi, w = n === bi ? null : Ni[m], M = n === _i ? null : Ai[m], N = Ei(b), A = N.extent, T = N.selection, S = A[0][0], k = A[0][1], E = A[1][0], C = A[1][1], P = w && M && t.event.shiftKey, z = Ot(b), R = z, D = f(b, arguments).beforestart();
        ...
        return u.move = function(t, e) {
            ...
            emit: function(t) {
                St(new li(u, t, n.output(this.state.selection)), o.apply, o, [
                    t,
                    this.that,
                    this.args
                ]);
        ...
        arcTo: function(t, n, e, r, i) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
                ...
                if (Math.abs(s * u - c * f) > 1e-6 && i) {
                    var h = e - o, d = r - a, p = u * u + c * c, v = h * h + d * d, g = Math.sqrt(p), y = Math.sqrt(l), _ = i * Math.tan((Yi - Math.acos((p + l - v) / (2 * g * y))) / 2), b = _ / y, m = _ / g;
    ...
    function ea(t, n, e, r) {
        ...
        do i = i ? i[l] = new Array(4) : t._root = new Array(4), (f = n >= (o = (v + y) / 2)) ? v = o : y = o, (s = e >= (a = (g + _) / 2)) ? g = a : _ = a;
    ...
    fa.copy = function() {
        ...
        for(v && p.push(new ra(v, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();)if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) {
            if (v.length) {
                var g = (i + a) / 2, y = (o + u) / 2;
            ...
            function m(t) {
                ...
                if ("c" === v) x = _(t) + x, t = "";
                    ...
                    if (t = _(Math.abs(t), d), p && (t = function(t) {
                        ...
                        for(i = -1, u = t.length; ++i < u;)if (48 > (f = t.charCodeAt(i)) || f > 57) {
    ...
    var Oa = 1e-6, Ba = 1e-12, Ya = Math.PI, Fa = Ya / 2, Ia = Ya / 4, ja = 2 * Ya, Ha = 180 / Ya, Xa = Ya / 180, Ga = Math.abs, Va = Math.atan, $a = Math.atan2, Wa = Math.cos, Za = Math.ceil, Qa = Math.exp, Ja = Math.log, Ka = Math.pow, tu = Math.sin, nu = Math.sign || function(t) {
    ...
    function Cc(t, n) {
        return [
            Ga(t) > Ya ? t + Math.round(-t / ja) * ja : t,
            n
        ];
    }
    function Pc(t, n, e) {
    ...
    function Lc(t, n, e, r, i, o) {
        if (e) {
            ...
            for(var f, s = i; r > 0 ? s > o : s < o; s -= c)f = Tu([
                a,
                -u * Wa(s),
                -u * tu(s)
            ]), t.point(f[0], f[1]);
    ...
    function Wc(t) {
        ...
        function a(t, e, r) {
            var i = [
                ...
                0,
                0
            ], o = Eu(Su(t), Su(e)), a = ku(o, o), u = o[0], c = a - u * u;
            if (!c) return !r && t;
            ...
            return {
                ...
                point: function(l, h) {
                    var d, p = [
                        l,
                        h
                    ], v = o(l, h), g = r ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? Ya : -Ya), h) : 0;
    ...
    function Jc(t, n, e, r) {
        ...
        function o(i, o, u, f) {
            var s = 0, l = 0;
            if (null == i || (s = a(i, u)) !== (l = a(o, u)) || c(i, o) < 0 ^ u > 0) do f.point(0 === s || 3 === s ? t : e, s > 1 ? r : n);
            while ((s = (s + u + 4) % 4) !== l);
        ...
        return function(a) {
            ...
            function M(o, a) {
                ...
                if (f && s.push([
                    o,
                    a
                ]), y) l = o, h = a, d = u, y = !1, u && (b.lineStart(), b.point(o, a));
                else if (u && g) b.point(o, a);
                else {
                    var c = [
                        p = Math.max(Qc, Math.min(Zc, p)),
                        v = Math.max(Qc, Math.min(Zc, v))
                    ], m = [
                        o = Math.max(Qc, Math.min(Zc, o)),
                        a = Math.max(Qc, Math.min(Zc, a))
                    ];
    ...
    function wf() {
        ...
        return _.lines = function() {
            ...
            return arguments.length ? (p = +t[0], v = +t[1], _) : [
                p,
                v
            ];
        }, _.stepMinor = function(t) {
            return arguments.length ? (h = +t[0], d = +t[1], _) : [
                h,
                d
            ];
    ...
    function Ms(t, n, e) {
        ...
        return t.scale(150).translate([
            0,
            0
        ]), null != r && t.clipExtent(null), du(e, t.stream(Bf)), n(Bf.result()), null != r && t.clipExtent(r), t;
    }
    function Ns(t, n, e) {
    ...
    function Cs(t, n) {
        return +n ? function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    var m = a + h, x = u + d, w = c + p, M = eu(m * m + x * x + w * w), N = ou(w /= M), A = Ga(Ga(w) - 1) < Oa || Ga(o - l) < Oa ? (o + l) / 2 : $a(x, m), T = t(A, N), S = T[0], k = T[1], E = S - r, C = k - i, P = _ * E - y * C;
    ...
    function Ds(t) {
        ...
        return A.stream = function(t) {
            ...
            return arguments.length ? (h = +t[0], d = +t[1], S()) : [
                h,
                d
            ];
        }, A.center = function(t) {
            return arguments.length ? (p = t[0] % 360 * Xa, v = t[1] % 360 * Xa, S()) : [
                p * Ha,
                v * Ha
            ];
        }, A.rotate = function(t) {
            return arguments.length ? (g = t[0] % 360 * Xa, y = t[1] % 360 * Xa, _ = t.length > 2 ? t[2] % 360 * Xa : 0, S()) : [
                g * Ha,
                y * Ha,
                _ * Ha
            ];
    ...
    function qs(t) {
        ...
        return i.parallels = function(t) {
            return arguments.length ? r(n = t[0] * Xa, e = t[1] * Xa) : [
                n * Ha,
                e * Ha
            ];
        }, i;
    ...
    function Ls(t, n) {
        ...
        return a.invert = function(t, n) {
            ...
            return [
                $a(t, Ga(e)) / r * nu(e),
                ou((i - (t * t + e * e) * r * r) / (2 * r))
            ];
        }, a;
    }
    function Us() {
        return qs(Ls).scale(155.424).center([
            0,
            33.6442
        ]);
    }
    ...
    function Hs(t) {
        ...
        function s() {
            var o = Ya * a(), u = i(qc(i.rotate()).invert([
                0,
                0
            ]));
            return c(null == f ? [
    ...
    var Ws = 1.340264, Zs = -0.081106, Qs = 893e-6, Js = .003796, Ks = eu(3) / 2;
    function tl(t, n) {
    ...
    function rl(t, n) {
        var e = n * n, r = e * e;
        return [
            t * (.8707 - .131979 * e + r * (r * (.003971 * e - .001529 * r) - .013791)),
            n * (1.007226 + e * (.015085 + r * (.028874 * e - .044475 - .005916 * r)))
        ];
    }
    function il(t, n) {
        return [
    ...
    function ll(t, n) {
        var e, r, i, o, a, u = new vl(t), c = +t.value && (u.value = t.value), f = [
            u
        ];
    ...
    tl.invert = function(t, n) {
        ...
        return [
            Ks * t * (Ws + 3 * Zs * i + o * (7 * Qs + 9 * Js * i)) / Wa(r),
            ou(tu(r) / Ks)
        ];
        ...
        return [
            t / (.8707 + (o = r * r) * (o * (o * o * o * (.003971 - .001529 * o) - .013791) - .131979)),
            r
        ];
        ...
        eachAfter: function(t) {
            for(var n, e, r, i = this, o = [
                i
            ], a = []; i = o.pop();)if (a.push(i), n = i.children) for(e = 0, r = n.length; e < r; ++e)o.push(n[e]);
            for(; i = a.pop();)t(i);
            return this;
        },
    ...
    function _l(t, n) {
        ...
        for(e = 0; e < t.length; ++e)if (bl(n, t[e]) && xl(Ml(t[e], n), t)) return [
            t[e],
            n
        ];
        for(e = 0; e < t.length - 1; ++e)for(r = e + 1; r < t.length; ++r)if (bl(Ml(t[e], t[r]), n) && bl(Ml(t[e], n), t[r]) && bl(Ml(t[r], n), t[e]) && xl(Nl(t[e], t[r], n), t)) return [
            t[e],
            t[r],
            n
        ];
    ...
    function Nl(t, n, e) {
        var r = t.x, i = t.y, o = t.r, a = n.x, u = n.y, c = n.r, f = e.x, s = e.y, l = e.r, h = r - a, d = r - f, p = i - u, v = i - s, g = c - o, y = l - o, _ = r * r + i * i - o * o, b = _ - a * a - u * u + c * c, m = _ - f * f - s * s + l * l, x = d * p - h * v, w = (p * m - v * b) / (2 * x) - r, M = (v * g - p * y) / x, N = (d * b - h * m) / (2 * x) - i, A = (h * y - d * g) / x, T = M * M + A * A - 1, S = 2 * (o + w * M + N * A), k = w * w + N * N - o * o, E = -(T ? (S + Math.sqrt(S * S - 4 * T * k)) / (2 * T) : k / S);
        return {
            x: r + w + M * E,
            y: i + N + A * E,
            r: E
    ...
    var ih = function t(n) {
        ...
        function e(t, e) {
            ...
            return t = null == t ? 0 : +t, e = null == e ? 1 : +e, function() {
                ...
                else do r = 2 * n() - 1, o = 2 * n() - 1, i = r * r + o * o;
                while (!i || i > 1);
    ...
    var hh = Array.prototype, dh = hh.map, ph = hh.slice, vh = {
        name: "implicit"
    };
    function gh() {
        var t = Qi(), n = [], e = [], r = vh;
    ...
    function yh() {
        var t, n, e = gh().unknown(void 0), r = e.domain, i = e.range, o = [
            0,
            1
        ], a = !1, u = 0, c = 0, f = .5;
        function s() {
    ...
    function $h(t, n, e, r) {
        ...
        return i.floor = i, i.ceil = function(e) {
            ...
            do u.push(a = new Date(+e)), n(e, o), t(e);
            while (a < e && e < r);
            return u;
        }, i.filter = function(e) {
            return $h(function(n) {
    ...
    var cd = ud(0), fd = ud(1), sd = ud(2), ld = ud(3), hd = ud(4), dd = ud(5), pd = ud(6), vd = cd.range, gd = fd.range, yd = sd.range, _d = ld.range, bd = hd.range, md = dd.range, xd = pd.range, wd = $h(function(t) {
    ...
    var Rd = zd(0), Dd = zd(1), qd = zd(2), Ld = zd(3), Ud = zd(4), Od = zd(5), Bd = zd(6), Yd = Rd.range, Fd = Dd.range, Id = qd.range, jd = Ld.range, Hd = Ud.range, Xd = Od.range, Gd = Bd.range, Vd = $h(function(t) {
    ...
    function tp(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months, c = t.shortMonths, f = cp(i), s = fp(i), l = cp(o), h = fp(o), d = cp(a), p = fp(a), v = cp(u), g = fp(u), y = cp(c), _ = fp(c), b = {
            a: function(t) {
                return a[t.getDay()];
            },
            A: function(t) {
    ...
    function Nv(t, n, r, i, o, a, u, c, f) {
        var s = Sh(mh, mh), l = s.invert, h = s.domain, d = f(".%L"), p = f(":%S"), v = f("%I:%M"), g = f("%I %p"), y = f("%a %d"), _ = f("%b %d"), b = f("%B"), m = f("%Y"), x = [
            [
                u,
                1,
                vv
    ...
    function Av() {
        ...
        return f.domain = function(i) {
            return arguments.length ? (t = r(o = +i[0]), n = r(a = +i[1]), e = t === n ? 0 : 1 / (n - t), f) : [
                o,
                a
            ];
        }, f.clamp = function(t) {
    ...
    function kv() {
        ...
        return h.domain = function(a) {
            return arguments.length ? (t = o(u = +a[0]), n = o(c = +a[1]), e = o(f = +a[2]), r = t === n ? 0 : .5 / (n - t), i = n === e ? 0 : .5 / (e - n), h) : [
                u,
                c,
                f
            ];
    ...
    function yy(t, n, e, r, i, o, a) {
        var u = t - e, c = n - r, f = (a ? o : -o) / ay(u * u + c * c), s = f * c, l = -f * u, h = t + s, d = n + l, p = e + s, v = r + l, g = (h + p) / 2, y = (d + v) / 2, _ = p - h, b = v - d, m = _ * _ + b * b, x = i - o, w = h * v - p * d, M = (b < 0 ? -1 : 1) * ay(ry(0, x * x * m - w * w)), N = (w * b - _ * M) / m, A = (-w * _ - b * M) / m, T = (w * b + _ * M) / m, S = (-w * _ + b * M) / m, k = N - g, E = A - y, C = T - g, P = S - y;
    ...
    var Yy = {
        ...
        draw: function(t, n) {
            ...
            t.moveTo(r, i), t.lineTo(o, a), t.lineTo(u, c), t.lineTo(-0.5 * r - Jy * i, Jy * r + -0.5 * i), t.lineTo(-0.5 * o - Jy * a, Jy * o + -0.5 * a), t.lineTo(-0.5 * u - Jy * c, Jy * u + -0.5 * c), t.lineTo(-0.5 * r + Jy * i, -0.5 * i - Jy * r), t.lineTo(-0.5 * o + Jy * a, -0.5 * a - Jy * o), t.lineTo(-0.5 * u + Jy * c, -0.5 * c - Jy * u), t.closePath();
        }
    }, e_ = [
        Yy,
        Fy,
    ...
    N_.prototype = {
        ...
        lineEnd: function() {
            ...
            if (e) {
                ...
                else for(var r = R_(t), i = R_(n), o = 0, a = 1; a < e; ++o, ++a)this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
            }
    ...
    function pb(t) {
        for(var n, e, r, i, o = t[0], a = t[1], u = yb._; u;)if ((r = vb(u, a) - o) > xb) u = u.L;
        else {
            if (!((i = o - gb(u, a)) > xb)) {
        ...
        if (yb.insert(n, c), n || e) {
            ...
            if (e) {
                cb(n), cb(e);
                var f = n.site, s = f[0], l = f[1], h = t[0] - s, d = t[1] - l, p = e.site, v = p[0] - s, g = p[1] - l, y = 2 * (h * g - d * v), _ = h * h + d * d, b = v * v + g * g, m = [
                    (g * _ - d * b) / y + s,
                    (h * b - v * _) / y + l
                ];
    ...
    function Nb(t, n) {
        ...
        for(mb = [], _b = new Array(t.length), yb = new X_, bb = new X_;;)if (i = ib, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (pb(o), e = o[0], r = o[1]), o = t.pop();
        else {
            if (!i) break;
            db(i.arc);
        }
        if (function() {
            ...
            !function(t, n, e, r) {
                ...
                for(i = 0; i < g; ++i)if (o = _b[i]) {
                    ...
                    for(u = 0, f = c.length; u < f;)p = (d = rb(o, mb[c[u]]))[0], v = d[1], l = (s = eb(o, mb[c[++u % f]]))[0], h = s[1], (Math.abs(p - l) > xb || Math.abs(v - h) > xb) && (c.splice(u, 0, mb.push(Q_(a, d, Math.abs(p - t) < xb && r - v > xb ? [
                        t,
                        Math.abs(l - t) < xb ? h : r
    ...
    Nb.prototype = {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length) for(var i, o, a, u, c, f, s = e.site, l = -1, h = n[i[o - 1]], d = h.left === s ? h.right : h.left; ++l < o;)a = d, d = (h = n[i[l]]).left === s ? h.right : h.left, a && d && r < a.index && r < d.index && (c = a, f = d, ((u = s)[0] - f[0]) * (c[1] - u[1]) - (u[0] - c[0]) * (f[1] - u[1]) < 0) && t.push([
                    s.data,
                    a.data,
                    d.data
                ]);
        ...
        find: function(t, n, e) {
            ...
            do i = o.cells[r = a], a = null, i.halfedges.forEach(function(e) {
    ...
    Eb.prototype = Sb.prototype, t.version = "5.9.2", t.bisect = i, t.bisectRight = i, t.bisectLeft = o, t.ascending = n, t.bisector = e, t.cross = function(t, n, e) {
        ...
        return r.value = function(n) {
            ...
            return arguments.length ? (n = "function" == typeof t ? t : p([
                t[0],
                t[1]
            ]), r) : n;
        ...
        function a() {
            var a, u = Oi.call(arguments), c = t.apply(this, u), f = n.apply(this, u), s = +e.apply(this, (u[0] = c, u)), l = r.apply(this, u) - qi, h = i.apply(this, u) - qi, d = s * zi(l), p = s * Ri(l), v = +e.apply(this, (u[0] = f, u)), g = r.apply(this, u) - qi, y = i.apply(this, u) - qi;
        ...
        function o(e, i, a, u) {
            ...
            for(var c, f, s, l = -1, h = e.length, d = r[i++], p = Qi(), v = a(); ++l < h;)(s = p.get(c = d(f = e[l]) + "")) ? s.push(f) : p.set(c, [
                f
            ]);
        ...
        function l(t, i, c, f) {
            ...
            if (!(t.length || d >= a)) {
                ...
                do t.data !== n && (h = r[t.data.index] * e / d, n.vx += s * h, n.vy += l * h);
                while (t = t.next);
            }
        }
        ...
        if (Lu = qu = -(Ru = Du = 1 / 0), Fu = [], du(t, ac), e = Fu.length) {
            for(Fu.sort(vc), n = 1, o = [
                r = Fu[0]
            ]; n < e; ++n)gc(r, (i = Fu[n])[0]) || gc(r, i[1]) ? (pc(r[0], i[1]) > pc(r[0], r[1]) && (r[1] = i[1]), pc(i[0], r[1]) > pc(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
        ...
        return i < Ba && (n = $u, e = Wu, r = Zu, Hu < Oa && (n = Xu, e = Gu, r = Vu), (i = n * n + e * e + r * r) < Ba) ? [
            NaN,
            NaN
        ] : [
            $a(e, n) * Ha,
        ...
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : kc([
                +t[0],
                +t[1]
            ]), a) : e;
        }, a.radius = function(t) {
        ...
        var e = t[0] * Xa, r = t[1] * Xa, i = n[0] * Xa, o = n[1] * Xa, a = Wa(r), u = tu(r), c = Wa(o), f = tu(o), s = a * Wa(e), l = a * tu(e), h = c * Wa(i), d = c * tu(i), p = 2 * ou(eu(au(o - r) + a * c * au(i - e))), v = tu(p), g = p ? function(t) {
        ...
        var t, n, e, r, i, o, a = Os(), u = Us().rotate([
            154,
            0
        ]).center([
            -2,
        ...
        return s.invert = function(t) {
            ...
            return (i >= .12 && i < .234 && r >= -0.425 && r < -0.214 ? u : i >= .166 && i < .234 && r >= -0.214 && r < -0.115 ? c : a).invert(t);
        }, s.stream = function(e) {
            var r, i;
            return t && n === e ? t : (r = [
                a.stream(n = e),
        ...
        return o = {
            ...
            translate: function(t) {
                return arguments.length ? (l = el(a * f, a * s, u = +t[0], c = +t[1]), p()) : [
                    u,
                    c
                ];
            },
        ...
        return i.separation = function(n) {
            ...
            return arguments.length ? (r = !1, n = +t[0], e = +t[1], i) : r ? null : [
                n,
                e
            ];
        }, i.nodeSize = function(t) {
            return arguments.length ? (r = !0, n = +t[0], e = +t[1], i) : r ? [
                n,
                e
            ] : null;
        }, i;
        ...
        return i.radius = function(n) {
            ...
            return arguments.length ? (n = +t[0], e = +t[1], i) : [
                n,
                e
            ];
        ...
        return i.round = function(t) {
            ...
            return arguments.length ? (t = +e[0], n = +e[1], i) : [
                t,
                n
            ];
        }, i.padding = function(t) {
        ...
        function e(e) {
            ...
            for(i = 0; i < s; ++i)if (u = l[i], null != (c = n(e[i], i, e)) && (c += "")) {
                ...
                a.children ? a.children.push(u) : a.children = [
                    u
                ], u.parent = a;
            } else {
        ...
        function i(i) {
            var c = function(t) {
                for(var n, e, r, i, o, a = new Wl(t, 0), u = [
                    a
                ]; n = u.pop();)if (r = n._.children) for(n.children = new Array(o = r.length), i = o - 1; i >= 0; --i)u.push(e = n.children[i] = new Wl(r[i], i)), e.parent = n;
                return (a.parent = new Wl(null, 0)).children = [
                    a
                ], a;
            }(i);
        ...
        var t = Kl, n = !1, e = 1, r = 1, i = [
            0
        ], o = Pl, a = Pl, u = Pl, c = Pl, f = Pl;
        function s(t) {
            return t.x0 = t.y0 = 0, t.x1 = e, t.y1 = r, t.eachBefore(l), i = [
                0
            ], n && t.eachBefore(Ul), t;
        }
        function l(n) {
        ...
        return s.round = function(t) {
            ...
            return arguments.length ? (e = +t[0], r = +t[1], s) : [
                e,
                r
            ];
        }, s.tile = function(n) {
        ...
        }, n = arguments.length ? dh.call(n, _h) : [
            0,
            1
        ], Eh(r);
        ...
        return c.domain = function(t) {
            return arguments.length ? (e = +t[0], r = +t[1], f()) : [
                e,
                r
            ];
        }, c.range = function(t) {
        ...
        return sh.apply(Nv(Nd, wd, cd, od, rd, nd, Kh, Wh, t.timeFormat).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2)
        ]), arguments);
    }, t.scaleUtc = function() {
        return sh.apply(Nv(Wd, Vd, Rd, Cd, kd, Td, Kh, Wh, t.utcFormat).domain([
            Date.UTC(2e3, 0, 1),
            Date.UTC(2e3, 0, 2)
        ]), arguments);
        ...
        function c() {
            ...
            if (u || (u = c = Hi()), h < l && (f = h, h = l, l = f), h > uy) {
                if (v > sy - uy) u.moveTo(h * ey(d), h * oy(d)), u.arc(0, 0, h, d, p, !g), l > uy && (u.moveTo(l * ey(p), l * oy(p)), u.arc(0, 0, l, p, d, g));
                    ...
                    var y, _, b = d, m = p, x = d, w = p, M = v, N = v, A = a.apply(this, arguments) / 2, T = A > uy && (r ? +r.apply(this, arguments) : ay(l * l + h * h)), S = iy(ty(h - l) / 2, +e.apply(this, arguments)), k = S, E = S;
                    if (T > uy) {
                    ...
                    if (S > uy) {
                        ...
                        if (v < cy && (L = function(t, n, e, r, i, o, a, u) {
                            ...
                            var F = z - L[0], I = R - L[1], j = U - L[0], H = O - L[1], X = 1 / oy(((s = (F * j + I * H) / (ay(F * F + I * I) * ay(j * j + H * H))) > 1 ? 0 : s < -1 ? cy : Math.acos(s)) / 2), G = ay(L[0] * L[0] + L[1] * L[1]);
        ...
        function a(a) {
            var u, c, f, s, l, h = a.length, d = 0, p = new Array(h), v = new Array(h), g = +r.apply(this, arguments), y = Math.min(sy, Math.max(-sy, i.apply(this, arguments) - g)), _ = Math.min(Math.abs(y) / h, o.apply(this, arguments)), b = _ * (y < 0 ? -1 : 1);
        ...
        function i(i) {
            ...
            for(o = 0; o < f; ++o){
                for(var l, h = u[o], d = s[o] = new Array(c), p = 0; p < c; ++p)d[p] = l = [
                    0,
                    +r(i[p], h, p, i)
                ], l.data = i[p];
                d.key = h;
        ...
        if (i) {
            for(r in n = null == n ? null : n + "", i)if ((e = i[r]).state > dr && e.name === n) return new Er([
                [
                    t
                ]
            ], fi, n, +r);
        ...
        var n, e, r = zb, i = Rb, o = Ub, a = qb, u = Lb, c = [
            0,
            1 / 0
        ], f = [
            [
        ...
        ], s = 250, l = De, h = [], d = I("start", "zoom", "end"), p = 500, v = 150, g = 0;
        function y(t) {
        ...
        return y.transform = function(t, n) {
            ...
            emit: function(t) {
                St(new Tb(y, t, this.that.__zoom), d.apply, d, [
                    t,
                    this.that,
                    this.args
                ]);
            ...
            return arguments.length ? (c[0] = +t[0], c[1] = +t[1], y) : [
                c[0],
                c[1]
            ];
...
//# sourceMappingURL=index.eb47e93a.js.map
